    ...
    ($.flexslider = function (t, a) {
        ...
        $.data(t, 'flexslider', n),
                            ...
                            (!x || Number(new Date()) - f > 500) &&
                                ...
                                !p &&
                                    ...
                                    (a.vars.animationLoop ||
                                        (m =
                                            w /
                                            ((0 === a.currentSlide && w < 0) || (a.currentSlide === a.last && w > 0)
                                                ? Math.abs(w) / c + 2
                                                : 1)),
                          ...
                          (h = function (e) {
                              ...
                              (!x || Number(new Date()) - f > 500) &&
                                  ...
                                  !p &&
                                      ...
                                      (n.vars.animationLoop ||
                                          (m /=
                                              (0 === n.currentSlide && m < 0) || (n.currentSlide === n.last && m > 0)
                                                  ? Math.abs(m) / c + 2
                                                  : 1),
            ...
            (n.setup = function (e) {
                if (p)
                    n.vars.rtl
                        ? n.slides.css({ width: '100%', float: 'right', marginLeft: '-100%', position: 'relative' })
